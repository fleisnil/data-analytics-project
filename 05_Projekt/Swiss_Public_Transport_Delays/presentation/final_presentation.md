...
- OLS on log delay for interpretable conditional associations.
- Random forest for out-of-sample evaluation.
- Chronological holdout and mean baseline.
...
- SQLite plus validated DuckDB SQL joins and PostgreSQL implementation
