...
3. Do weather associations differ across modes or regions?
...
4. Join weather using `station_id + local hour`.
...
- A national, multi-mode comparison rather than a single-route prediction.
- Transparent separation of association and causality.
- Reproducible API collection, SQLite, DuckDB/PostgreSQL and GitHub code.
...
- Repeated calls/journeys → stable keys and deduplication.
